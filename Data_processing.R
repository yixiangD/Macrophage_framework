...
ggplot(data = df, aes(
  x = factor(stage.o), fill = factor(stage.o),
  y = stage.score
)) +
  geom_violin() +
...
# UMAP clustering based on K means
inertia <- c()
for (i in c(1:20)) {
